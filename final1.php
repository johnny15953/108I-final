...
if($_POST){
    if(
		...
		$trafficfee = $_POST['trafficfee'];
		$place1 = $_POST['place1'];
		$hotelfee = $_POST['hotelfee'];
		$startdate = strtotime($starttime);
		$enddate = strtotime($endtime);
		$day=round(($enddate-$startdate)/86400);
	try{
		...
		$form->Textbox4 = $place1;
		$form->Textbox5 = $day;
		$form->Textbox6 = $trafficfee;
		$form->Textbox7 = $hotelfee;
        $result = $form->asXML();
    ...
    <div class="row">
      ...
      <div class="col-md-12 order-md-1">
        ...
        <form class="needs-validation" method="POST" action="./index.php">
		  ...
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="place1">出差地點</label>
                  <input name="place1" type="text" class="form-control" id="place1" placeholder="" value="" >
                </div>
          </div>
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="trafficfee">車馬費</label>
                  <input name="trafficfee" type="text" class="form-control" id="trafficfee" placeholder="" value="" >
                </div>
          </div>
		  <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="hotelfee">住宿費</label>
                  <input name="hotelfee" type="text" class="form-control" id="hotelfee" placeholder="" value="" >
                </div>
          </div>
